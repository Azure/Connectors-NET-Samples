...
/// <see cref="TeamsClient"/>, and <see cref="MsgraphgroupsanduserClient"/> from the DirectClient SDK.
/// </summary>
/// <remarks>
...
public class ConnectorFunctions
{
    ...
    /// <param name="msGraphClient">The DI-injected MS Graph Groups and Users client (disposed by the host).</param>
